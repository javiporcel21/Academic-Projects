...
}#ESTA LLAVE CIERRA LA REPETICIÓN DEL HOLD-OUT
...
metodo<-rep(c("tree","knn","nbayes","nbayes.laplace","svm","svp","rf","nn","pls","simca", "bagging", "boosting"), each=100)
...
t.test(tasa[metodo=="boosting"], tasa[metodo=="nbayes"], alternative = c("two.sided", "less", "greater"), paired = TRUE, var.equal = FALSE, conf.level = 0.95)
